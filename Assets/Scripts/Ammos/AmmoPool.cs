...
namespace SpaceJailRunner.Ammos
{
    ...
    {
    //     private readonly Dictionary<string, HashSet<Ammo>> _turretBallsPool;
    //     private readonly int _capacityPool;
    //     private Transform _rootPool;
    //     
    //     
    //     public AmmoPool(int capacityPool, AmmoAbstractFactory ammoAbstractFactory, AmmoType ammoType)
    //     {
    //         _turretBallsPool = new Dictionary<string, HashSet<Ammo>>();
